package io.github.jelilio.smbackend.apigateway.web.rest.usermanager.community;

import io.github.jelilio.smbackend.apigateway.client.usermanager.community.UmAccountProxy;
...
public class UmAccountApi {
  ...
  public Uni<RegisterRes> register(@Valid @RequestBody RegisterCommunityDto dto) {
    return userManagerApi.registerClub(dto);
  }
}
